            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="flex flex-col justify-center">
                        <h1 className="text-2xl font-bold">Sunflower VISA Navigator</h1>
                        <p className="mt-2 text-sm">© 2024 Sunflower VISA Navigator. All rights reserved.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-2">
                            <li>Email: <a href="mailto:info@sunflowervisa.com" className="text-blue-400 hover:text-blue-500">info@sunflowervisa.com</a></li>

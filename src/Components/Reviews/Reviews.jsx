    ...
    return (
        <section className="testimonials-section py-16 w-11/12 mx-auto">
            <div className="container mx-auto px-4">
                <h2
                    className="text-3xl font-bold mb-8 text-center text-custom-darkGreen"
                    data-aos="fade-up"
                >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <Fade direction="up" triggerOnce delay={100}>
                        <div className="testimonial-card p-6 border-2 border-gray-300 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300">
